                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  if (getOneProduct.list.oneProduct.favorite ==
                                      '1') {
                                    getFavorite.deleteFavorite(
                                        widget.id, context);
                                    Provider.of<GetOneProductProvider>(context,
                                            listen: false)
                                        .callAPIForGetOneProductData(widget.id);
                                  } else {
                                    getFavorite.addFavorite(widget.id, context);
                                    Provider.of<GetOneProductProvider>(context,
                                            listen: false)
                                        .callAPIForGetOneProductData(widget.id);
                                  }
